...
public class PoisonDartTrap implements Attack {
    ...
    public void use(String attacker, Creature target, int attackPower, List<Dice> attackDice) {
        ...
        System.out.println(target.getName() + " activated a poison dart trap!!");
        D20 d20 = new D20();
        ...
        if (attackRoll == 20) {
            ...
            System.out.println(target.getName() + " dodges the darts!");
        }
    ...
    public String description() {
        return "Poison darts fire out of a hole in the wall.";
    }
