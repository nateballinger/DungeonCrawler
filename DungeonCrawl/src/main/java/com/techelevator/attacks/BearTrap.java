...
public class BearTrap implements Attack {
    ...
    public void use(String attacker, Creature target, int attackPower, List<Dice> attackDice) {
        ...
        System.out.println(target.getName() + " activated a bear trap!!");
        D20 d20 = new D20();
        ...
        if (attackRoll == 20) {
            ...
            System.out.println("The trap is jammed!!");
        }
    ...
    public String description() {
        return "A bear trap snaps on the ankle of whomever steps on it.";
    }
